  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        : we use it to configure global settings (dfp id, etc).
      </p>
      <p>
      ...
      <p>
        <strong>- DFPManager.refresh(...id)</strong>
        : after the ads have been rendered, we use this method to
        refresh them at a defined time interval.
      </p>
    </Fragment>
  );
}
