...
export default function(props) {
    return (
        <Fragment>
            ...
            <p>
                <bold>- DFPSlotsProvider</bold>: this component is only meant
                to configure global options, it follows the context provider
                pattern ({<Link href="https://reactjs.org/docs/context.html"><a> see this link for details </a></Link>}),
            ...
            <p>
                <bold>- AdSlot</bold>: this component is meant to define ad
                slots in your application.
            </p>
            <p>
                <bold>- DFPManager</bold>: this library makes an abstraction of
                ...
                see the <Link href="/examples/refreshable"><a> refreshable ads example </a></Link>).
