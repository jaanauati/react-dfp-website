...
export default () => (
  <ol>
    <li>
      Line 21: Declare a toplevel <strong>&lt;DFPSlotProvider&gt;</strong>.
      This instance provides two things: 1) Basic configuration params that are
      shared among all the ads in the page and 2) Takes care of initializing ads
    ...
    <li> Line 30: define a refreshable ad-slot using the <strong>&lt;AdSlot&gt;</strong> component.</li>
