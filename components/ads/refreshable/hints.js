...
export default () => (
    <ol>
        <li>
            Line 22: Declare a toplevel <strong>&lt;DFPSlotProvider&gt;</strong>,
        ...
        <li>
            ...
            when calling <strong> DFPManager.refresh(); </strong>. Notice that
            the prop shouldRefresh receives a function that gets evaluated
            syncrhonously; this function is called by <strong> DFPManager.refresh()</strong>
